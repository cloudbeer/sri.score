    ...
    <div class="span12">
        ...
        <div class="well widget">
            ...
            <div class="widget-content">
                ...
                <div id="edit-TUser" class="content scaffold-edit" role="main">
                    ...
                    <g:hasErrors bean="${TUserInstance}">
                        <div class="alert alert-block alert-error">
                            <a class="close" data-dismiss="alert" href="#"><i class="icon-large icon-remove-circle"></i></a>
                            <h4 class="alert-heading"><g:message code="default.tip.label" default="出错了"/></h4>
                            <ul class="errors" role="alert">
                                <g:eachError bean="${TUserInstance}" var="error">
                    ...
                    <g:form method="post">
                        ...
                        <g:hiddenField name="version" value="${TUserInstance?.version}"/>
                        <fieldset class="form">
